...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 06:00 AM
...
(1, 'Dave', 'Jones', 'dj17@gmail.com', 2),
(2, 'James', 'Ross', '', 10),
(3, 'John', 'Mayson', 'jm@gmail.com', 1);
...
--
ALTER TABLE `sales`
  ADD CONSTRAINT `fk_custid` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
